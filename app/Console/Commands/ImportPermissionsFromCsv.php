...
class ImportPermissionsFromCsv extends Command
{
  /**
   ...
   * @var string
   */
  protected $signature = 'permissions:import {file=new_permissions.csv} {--chunk=1000}';
   ...
   * @var string
   */
  protected $description = 'Import permissions from CSV file';
  ...
  public function handle()
  {
    ...
    while (($row = fgetcsv($file)) !== false) {
      ...
      $permissionData = $this->preparePermissionData($data);
  ...
  /**
   * Prepare permission data from CSV row
   */
  private function preparePermissionData(array $data): array|false|null
  {
    try {
